...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var app_services_badge_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/services/badge.service */ "./src/app/services/badge.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddReaderComponent = /** @class */ (function () {
    function AddReaderComponent(badgeService) {
    ...
    AddReaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_services_badge_service__WEBPACK_IMPORTED_MODULE_1__["BadgeService"]])
    ], AddReaderComponent);
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getAllReaders = function () {
        return this.http
            .get("/api/readers")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.hanldeError));
    };
    DataService.prototype.hanldeError = function (error) {
    ...
    DataService.prototype.setMostPopularBook = function (book) {
        this.mostPopularBook = book;
    };
    DataService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        __metadata("design:paramtypes", [_logger_service__WEBPACK_IMPORTED_MODULE_4__["LoggerService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]])
    ], DataService);
    return DataService;
}());
...
function throwIfAlreadyLoaded(parentModule, moduleName) {
    if (parentModule) {
        throw new Error(moduleName + " has already been loaded. Import Core modules in the AppModule ");
    }
}
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getAllReaders().subscribe(function (data) { return (_this.allReaders = data); }, function (err) { return console.log(err.friendlyMessage); }, function () { return _this.loggerService.log("All done getting readers!"); });
        this.dataService.getAuthorRecommendation(1).then(function (author) { return _this.loggerService.log(author); }, function (err) {
            return _this.loggerService.log("The promise was rejected: " + err);
        });
...
var EditBookComponent = /** @class */ (function () {
    function EditBookComponent(route, loggerService, dataService) {
        this.route = route;
        this.loggerService = loggerService;
        this.dataService = dataService;
    }
    ...
    EditBookComponent.prototype.setMostPopular = function () {
        ...
        this.loggerService.log("New mos popular book: " + this.selectedBook.title);
    };
...
module.exports = "<div class=\"col-lg-5\">\r\n  <div class=\"well bs-component\">\r\n    <form class=\"form-horizontal\">\r\n      <fieldset>\r\n        <legend>Edit Reader</legend>\r\n        <div class=\"form-group\">\r\n          <label for=\"inputGoal\" class=\"col-lg-3 control-label\">Name</label>\r\n          <div class=\"col-lg-8\">\r\n            <input type=\"text\" class=\"form-control\" id=\"inputGoal\" placeholder=\"Name\" [(ngModel)]=\"selectedReader.name\"\r\n              name=\"name\">\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <label for=\"inputGoal\" class=\"col-lg-3 control-label\">Weekly Goal</label>\r\n          <div class=\"col-lg-8\">\r\n            <input type=\"text\" class=\"form-control\" id=\"inputGoal\" placeholder=\"Weekly Goal\"\r\n              [(ngModel)]=\"selectedReader.weeklyReadingGoal\" name=\"weeklyReaddingGoal\">\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <label for=\"inputTotal\" class=\"col-lg-3 control-label\">Total Read</label>\r\n          <div class=\"col-lg-8\">\r\n            <input type=\"text\" class=\"form-control\" id=\"inputTotal\" placeholder=\"Total Minutes Read\"\r\n              [(ngModel)]=\"selectedReader.totalMinutesRead\" name=\"totalMinutesRead\">\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <label for=\"inputTotal\" class=\"col-lg-3 control-label\">Current Badge </label>\r\n          <div class=\"col-lg-8\">\r\n            {{currentBadge}}\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <div class=\"col-lg-10 col-lg-offset-3\">\r\n            <button type=\"button\" class=\"btn btn-primary\" (click)=\"saveChanges()\">Save</button>\r\n          </div>\r\n        </div>\r\n      </fieldset>\r\n    </form>\r\n  </div>\r\n</div>\r\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var app_services_badge_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/services/badge.service */ "./src/app/services/badge.service.ts");
...
var EditReaderComponent = /** @class */ (function () {
    ...
    EditReaderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [],
            providers: [app_services_badge_service__WEBPACK_IMPORTED_MODULE_2__["BadgeService"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            app_core_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"],
            app_services_badge_service__WEBPACK_IMPORTED_MODULE_2__["BadgeService"]])
    ], EditReaderComponent);
...
module.exports = __webpack_require__(/*! C:\Users\aless\Documents\Fabian\Angular\angular-services\03\demos\demos\Before\BookTracker\src\main.ts */"./src/main.ts");
